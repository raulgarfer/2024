...
$(eval $(call IMG2SP, SET_IMG_FORMAT  , sprites            ))	#{ sprites, zgtiles, screen }
$(eval $(call IMG2SP, CONVERT         , src/sprites/ladrillo.png , 0, 0, ladrillo))

$(eval $(call IMG2SP, SET_IMG_FORMAT  , zgtiles            ))	#{ sprites, zgtiles, screen }
$(eval $(call IMG2SP, CONVERT         , src/sprites/tileset.png , 8, 8, tiles))
